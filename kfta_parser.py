...
class KFTAParser:
    ...
    GANGWON_ALL_SCHOOLS = {
        ...
        '강현초등학교': '강원특별자치도속초양양교육지원청',
        '현북초등학교': '강원특별자치도속초양양교육지원청',

        # === 삼척 지역 ===
        '근덕초등학교': '강원특별자치도삼척교육지원청',
        '도계초등학교': '강원특별자치도삼척교육지원청',
        '원덕초등학교': '강원특별자치도삼척교육지원청',

        # === 홍천 지역 ===
        '홍천초등학교': '강원특별자치도홍천교육지원청',
        '남산초등학교': '강원특별자치도홍천교육지원청',  # 중복
        ...
        '갈말초등학교': '강원특별자치도철원교육지원청',

        # === 화천 지역 ===
        '간동초등학교': '강원특별자치도화천교육지원청',
        '사내초등학교': '강원특별자치도화천교육지원청',

        # === 양구 지역 ===
        '동산초등학교': '강원특별자치도양구교육지원청',
        ...
        '송지호초등학교': '강원특별자치도고성교육지원청',

        # === 중학교 ===
        '중앙중학교': '강원특별자치도춘천교육지원청',
